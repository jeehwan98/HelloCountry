...
public class redoApplication7 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("성실 점수 입력 : ");    // 성실 점수
        int sincerity = sc.nextInt();

        System.out.print("서비스 점수 입력 : ");   // 서비스 점수
        int service = sc.nextInt();

        System.out.print("미소 점수 입력 : ");    // 미소 점수
        int smile = sc.nextInt();

        int sumOfNum = sincerity + service + smile;
        int averageNum = (int)(sumOfNum / 3);

        if(averageNum >= 60 && service >= 40 && sincerity >= 40 && smile >= 40) {
